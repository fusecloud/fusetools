...
class PDF:
    ...
    @classmethod
    def text_to_pdf(cls, text, filename):
        """
        Convert a multi-line text to a PDF file in a "report look" by using a monospaced font. Too long lines are wrapped at spaces so that it will fit the page width.

        Kudos to m13r on StackOverflow: https://stackoverflow.com/questions/10112244/convert-plain-text-to-pdf-in-python
